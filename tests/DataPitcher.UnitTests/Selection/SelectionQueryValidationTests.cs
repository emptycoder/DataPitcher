...
public sealed class SelectionQueryValidationTests
{
    ...
    public void SelectionQuery_AcceptsEveryTypedOperatorAndNestedBooleanTree()
    {
        var orders = T(
            ...
            ("Occurred", typeof(DateTime), false)
        );
        ...
        var query = new SelectionQuery(
            ...
            root,
            Key(orders),
            [new ForeignKeyJoin("o", "l0", fk, RelationshipDirection.Reverse)],
            new NotPredicate(new OrPredicate([new AndPredicate(p), new NotPredicate(p[0])]))
        );
        Assert.Equal(orders, query.Root.Table);
    ...
    public void SelectionQuery_RejectsInvalidManualJoinAlias(string alias, string message)
    {
        ...
        var other = T("sales", "Other", ("OrderId", typeof(int), false));
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                new([orders, other], []),
                new(orders, "o"),
                Key(orders),
                [new ManualJoin("o", alias, other, [new("Id", "OrderId")])],
                null
            )
        );
    ...
    {
        var orders = T("sales", "Orders", ("Id", typeof(int), false));
        var other = T("sales", "Other", ("Code", typeof(string), false));
        var schema = new SelectionSchema([orders, other], []);
        Assert.Contains(
            "does not exist",
            Assert
                .Throws<ArgumentException>(() =>
                    new SelectionQuery(
                        ...
                        new(orders, "o"),
                        Key(orders),
                        [new ManualJoin("o", "x", other, [new("Missing", "Code")])],
                        null
                    )
                )
                .Message
            ...
            Assert
                .Throws<ArgumentException>(() =>
                    new SelectionQuery(
                        ...
                        new(orders, "o"),
                        Key(orders),
                        [new ManualJoin("o", "x", other, [new("Id", "Code")])],
                        null
                    )
                )
                .Message
            ...
            Assert
                .Throws<ArgumentException>(() =>
                    new SelectionQuery(
                        ...
                        Key(orders),
                        [],
                        new ComparisonPredicate(new("o", "Id"), SelectionComparison.Equal, V<string>("1"))
                    )
                )
                .Message
        );
    ...
    {
        var error = Assert.Throws<ArgumentException>(() =>
            SelectionQueryTestData.Query(new AndPredicate([SelectionQueryTestData.Id(1)]))
        );
    ...
    public void SelectionQuery_RejectsAliasWithTrailingNewline()
    {
        ...
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                ...
                new(orders, "o"),
                Key(orders),
                [new ManualJoin("o", "joined\n", other, [new("Id", "OrderId")])],
                null
            )
        );
    ...
    public void SelectionQuery_RejectsPredicateColumnAliasOutsideScope()
    {
        var error = Assert.Throws<ArgumentException>(() =>
            SelectionQueryTestData.Query(
                new ComparisonPredicate(new("missing", "Id"), SelectionComparison.Equal, new(typeof(int), 1))
            )
        );
    ...
    public void SelectionQuery_RejectsTextPredicateForNonTextColumn()
    {
        var error = Assert.Throws<ArgumentException>(() =>
            SelectionQueryTestData.Query(
                new TextPredicate(new("o", "Id"), TextMatch.Contains, new(typeof(string), "x"))
            )
        );
        Assert.Contains("Predicate is not semantically valid", error.Message);
    }
    ...
    {
        var error = Assert.Throws<ArgumentException>(() =>
            SelectionQueryTestData.Query(new BooleanPredicate(new("o", "Id"), new(typeof(bool), true)))
        );
        Assert.Contains("Predicate is not semantically valid", error.Message);
    }
    ...
    public void SelectionQuery_ValidatesNestedExistsPredicate()
    {
        ...
        var query = new SelectionQuery(
            ...
            new ExistsPredicate(
                lines,
                "l",
                [new(new("o", "Id"), "OrderId")],
                new ComparisonPredicate(new("l", "Id"), SelectionComparison.GreaterThan, V(0)),
                false
            )
        );
    ...
    {
        var orders = T("sales", "Orders", ("Id", typeof(int), false));
        var lines = T("sales", "Lines", ("OrderCode", typeof(string), false));
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                new([orders, lines], []),
                new(orders, "o"),
                Key(orders),
                [],
                new ExistsPredicate(lines, "l", [new(new("o", "Id"), "OrderCode")], null, false)
            )
        );
    ...
    public void SelectionQuery_RejectsRootTableOutsideSelectionSchema()
    {
        var orders = T("sales", "Orders", ("Id", typeof(int), false));
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(new([], []), new(orders, "o"), Key(orders), [], null)
        );
    ...
    public void SelectionQuery_RejectsRootWithoutStableKey()
    {
        var orders = T("sales", "Orders", ("Id", typeof(int), false));
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(new([orders], []), new(orders, "o"), StableKeySelection.NoStableKey, [], null)
        );
    ...
    public void SelectionQuery_RejectsRootStableKeyWithUnknownColumn()
    {
        ...
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                new([orders], []),
                new(orders, "o"),
                new(new UniqueConstraint("UQ_Orders_Missing", ["Missing"])),
                [],
                null
            )
        );
    ...
    public void SelectionQuery_RejectsForeignKeyJoinOutsideSelectionSchema()
    {
        ...
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                ...
                new(lines, "l"),
                Key(lines),
                [new ForeignKeyJoin("l", "o", fk, RelationshipDirection.Forward)],
                null
            )
        );
    ...
    public void SelectionQuery_RejectsForeignKeyJoinFromWrongTable()
    {
        ...
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                ...
                new(orders, "o"),
                Key(orders),
                [new ForeignKeyJoin("o", "l", fk, RelationshipDirection.Forward)],
                null
            )
        );
    ...
    {
        var orders = T("sales", "Orders", ("Id", typeof(int), false));
        var lines = T("sales", "Lines", ("OrderId", typeof(int), false));
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                new([orders], []),
                new(orders, "o"),
                Key(orders),
                [new ManualJoin("o", "l", lines, [new("Id", "OrderId")])],
                null
            )
        );
    ...
    public void SelectionQuery_RejectsJoinFromAliasOutsideScope()
    {
        ...
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                ...
                new(orders, "o"),
                Key(orders),
                [new ManualJoin("missing", "l", lines, [new("Id", "OrderId")])],
                null
            )
        );
    ...
    public void SelectionQuery_RejectsExistsTableOutsideSelectionSchema()
    {
        ...
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                ...
                Key(orders),
                [],
                new ExistsPredicate(lines, "l", [new(new("o", "Id"), "OrderId")], null, false)
            )
        );
    ...
    {
        var orders = T("sales", "Orders", ("Id", typeof(int), false));
        var lines = T("sales", "Lines", ("Id", typeof(int), false));
        var error = Assert.Throws<ArgumentException>(() =>
            new SelectionQuery(
                new([orders, lines], []),
                new(orders, "o"),
                Key(orders),
                [],
                new ExistsPredicate(lines, "l", [], null, false)
            )
        );
    ...
    {
        var error = Assert.Throws<ArgumentException>(() =>
            SelectionQueryTestData.Query(new TextPredicate(new("o", "Name"), (TextMatch)99, V("value")))
        );
        Assert.Contains("Predicate is not semantically valid", error.Message);
    }
    ...
    {
        var error = Assert.Throws<ArgumentException>(() =>
            SelectionQueryTestData.Query(new UnknownSelectionPredicate())
        );
        Assert.Contains("Predicate is not semantically valid", error.Message);
    }

    private static SelectionParameterValue V<T>(T value)
        where T : notnull => new(typeof(T), value);

    private static StableKeySelection Key(TableDefinition table) =>
        new(new UniqueConstraint("PK_" + table.Name, ["Id"]));

    private static TableDefinition T(
        string schema,
        string name,
        params (string Name, Type Type, bool Nullable)[] columns
    ) =>
        new(
            schema,
            name,
            columns.Select(c => new ColumnDefinition(c.Name, c.Type, c.Nullable)).ToArray(),
...
internal static class SelectionQueryTestData
{
    ...
    public static SelectionQuery Query(SelectionPredicate predicate) =>
        new(new([Orders], []), new(Orders, "o"), new(Orders.PrimaryKey), [], predicate);

    public static ComparisonPredicate Id(int value) =>
        new(new("o", "Id"), SelectionComparison.Equal, new(typeof(int), value));

    public static SelectionQuery WithUnvalidatedPredicate(SelectionPredicate predicate)
    {
        var query = Query(Id(1));
        typeof(SelectionQuery)
            .GetField(
                "<Predicate>k__BackingField",
                System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic
            )!
            .SetValue(query, predicate);
        return query;
    }
    ...
    public static SelectionQuery QuotedRootAndJoin()
    {
        var orders = new TableDefinition(
            "sales",
            "Order\"Rows",
            [new("Id", typeof(int), false), new("CustomerId", typeof(int), false)],
            new("PK_OrderRows", ["Id"]),
            []
        );
        var customers = new TableDefinition(
            "sales",
            "Customers",
            [new("Id", typeof(int), false), new("RegionId", typeof(int), false)],
            new("PK_Customers", ["Id"]),
            []
        );
        var regions = new TableDefinition(
            "sales",
            "Regions",
            [new("Id", typeof(int), false)],
            new("PK_Regions", ["Id"]),
        ...
        return new(
            new([orders, customers, regions], [foreignKey]),
            new(orders, "r"),
            new(orders.PrimaryKey),
            [
                new ForeignKeyJoin("r", "c", foreignKey, RelationshipDirection.Forward),
                new ManualJoin("c", "g", regions, [new("RegionId", "Id")]),
            ],
            null
        );
    }
    ...
    {
        SelectionParameterValue V<T>(T value)
            where T : notnull => new(typeof(T), value);
        var column = new SelectionColumn("o", "Id");
        foreach (
            var predicate in new SelectionPredicate[]
            {
                new ComparisonPredicate(column, SelectionComparison.Equal, V(1)),
                new ComparisonPredicate(column, SelectionComparison.NotEqual, V(2)),
                new ComparisonPredicate(column, SelectionComparison.GreaterThan, V(3)),
                new ComparisonPredicate(column, SelectionComparison.GreaterOrEqual, V(4)),
                new ComparisonPredicate(column, SelectionComparison.LessThan, V(5)),
                new ComparisonPredicate(column, SelectionComparison.LessOrEqual, V(6)),
                new BetweenPredicate(column, V(7), V(8)),
                new SetPredicate(column, false, [V(9)]),
                new SetPredicate(column, true, [V(10)]),
                new NullPredicate(new("o", "Name"), false),
                new NullPredicate(new("o", "Name"), true),
                new TextPredicate(new("o", "Name"), TextMatch.Contains, V("a")),
                new TextPredicate(new("o", "Name"), TextMatch.StartsWith, V("b")),
                new TextPredicate(new("o", "Name"), TextMatch.EndsWith, V("c")),
                new BooleanPredicate(new("o", "Active"), V(true)),
                new TemporalRangePredicate(
                    new("o", "Day"),
                    TemporalKind.Date,
                    V(new DateOnly(2026, 9, 2)),
                    V(new DateOnly(2026, 9, 3))
                ),
                new TemporalRangePredicate(
                    new("o", "At"),
                    TemporalKind.Time,
                ...
                new TemporalRangePredicate(
                    ...
                    V(new DateTime(2026, 9, 2)),
                    V(new DateTime(2026, 9, 3))
                ),
            }
        )
            yield return Query(predicate);
        var lines = new TableDefinition(
            "sales",
            "Lines",
            [new("Id", typeof(int), false), new("OrderId", typeof(int), false)],
            new("PK_Lines", ["Id"]),
            []
        );
        yield return new(
        ...
        yield return new(
            ...
            new(Orders.PrimaryKey),
            [],
            new ExistsPredicate(lines, "l", [new(new("o", "Id"), "OrderId")], null, true)
        );
    }
}
