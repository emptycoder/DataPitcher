...
{
    [Fact]
    public void StableKeySelector_WhenTableHasPrimaryKey_UsesPrimaryKey()
    {
        var primary = new UniqueConstraint("PK_Orders", ["Id"]);
        Assert.Equal(
            primary,
            StableKeySelector.Select(new TableDefinition("dbo", "Orders", [], primary, []), null).Constraint
        );
    }

    [Fact]
    public void StableKeySelector_WhenNoPrimaryKeyAndNoSelectedUnique_ReportsBlocked()
    {
        var result = StableKeySelector.Select(
            new TableDefinition("dbo", "Logs", [], null, [new("UQ_Code", ["Code"])]),
            null
        );
    ...
    [Fact]
    public void StableKeySelector_WhenUniqueConstraintExplicitlySelected_UsesIt()
    {
    ...
    [Fact]
    public void StableKeySelector_WhenSelectedConstraintNamesUnknownColumn_ReportsBlocked()
    {
    ...
    [Fact]
    public void TableDefinition_WhenRehydratedWithTheSameSchemaAndName_IsEqual()
    {
    ...
    [Fact]
    public void StableKeySelector_WhenSelectedUniqueConstraintHasNullableColumn_ReportsBlocked()
    {
    ...
    [Fact]
    public void StableKeySelector_WhenSelectedUniqueConstraintColumnsAreAllNonNull_UsesIt()
    {
        var unique = new UniqueConstraint("UQ_Code", ["Code"]);
        var table = new TableDefinition(
            "dbo",
