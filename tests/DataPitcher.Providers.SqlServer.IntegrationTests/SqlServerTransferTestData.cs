...
{
    public static SqlServerWriteTable Table() =>
        new(
    ...
    public static SqlServerWriteTable TextKeyTable() =>
        new(
            new TableAddress("dbo", "transfer_rows"),
            [
                new(
    ...
    public static SqlServerTransferBatch Batch(long sequence, params (int Id, string Code)[] rows) =>
        new(
            sequence,
    ...
    public static SqlServerExecutionContext Context(long fence = 1) =>
