...
public sealed record SelectionRequestBody(string Mode, object? Visual, string? RawSql, IReadOnlyList<TypedParameterValueRequest> Parameters, string SchemaRevision);
