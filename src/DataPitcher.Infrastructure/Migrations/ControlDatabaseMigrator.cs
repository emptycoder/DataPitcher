...
{
    private static readonly (int Version, string Resource)[] Scripts = [(1, "DataPitcher.Infrastructure.Migrations.0001-initial.sql"), (2, "DataPitcher.Infrastructure.Migrations.0002-job-recovery.sql")];
