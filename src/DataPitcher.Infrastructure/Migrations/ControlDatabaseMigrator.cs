...
public sealed class ControlDatabaseMigrator(ControlDatabase database, IClock clock)
{
    ...
    [
        (1, "DataPitcher.Infrastructure.Migrations.0001-initial.sql"),
        (2, "DataPitcher.Infrastructure.Migrations.0002-job-recovery.sql"),
        (3, "DataPitcher.Infrastructure.Migrations.0003-job-events.sql"),
        (4, "DataPitcher.Infrastructure.Migrations.0004-connections-and-schema.sql"),
        (5, "DataPitcher.Infrastructure.Migrations.0005-selections-and-plans.sql"),
        (6, "DataPitcher.Infrastructure.Migrations.0006-plan-content.sql"),
        (7, "DataPitcher.Infrastructure.Migrations.0007-selection-connection-and-snapshot.sql"),
        (8, "DataPitcher.Infrastructure.Migrations.0008-plan-associations.sql"),
        (9, "DataPitcher.Infrastructure.Migrations.0009-selection-root-identity.sql"),
    ];
